...
<%
	...
	String[] arrCognome = cognome.split(" ");
	String[] arrEmail = email.split(" ");
	String[] arrPassword = password.split(" ");
%>
<h1>Benvenuta/o <%out.println(arrNome[2]+" "+ arrCognome[2]);%></h1>
<form method="post" action="http://localhost:8080/Sample-WebApp/Login">
	<pre>
		Email: <input type="text" name="email" placeholder="Inserisci la tua email">
		Password: <input type="text" name="password" placeholder="Inserisci la tua password">
